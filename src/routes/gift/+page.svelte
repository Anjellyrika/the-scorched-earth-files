<main class="bg-secondary-700 flex min-h-screen flex-col items-center gap-8 p-20 text-center">
	...
	<h2 class="text-surface-200">Scorched Earth is the gift that keeps on giving.</h2>
	<p class="text-surface-300">
		I've made a lot of happy memories playing Scorched Earth with you guys. It's still a work in
	...
	<p class="text-surface-300">
		P.P.S. I'll remove this greeting page after your birthday is done
	</p>
</main>
